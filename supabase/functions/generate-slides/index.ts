...
STEP 3 — From their answers, extract and return a JSON object with EXACTLY this structure:
{
  ...
  "offerNarrative": "**Imagine this:** You are hired. And you do an intake and turn that into a **simple plan** for them to [overcome their crisis]. Then you **train them** and walk alongside them as they [future positive outcome]. **Coaching and advising** them for several months until [positive end state].",
  "_offerNarrative_instructions": "IMPORTANT: The offerNarrative value must be ONLY the client-facing paragraph. Do NOT include any instructions, meta-commentary, or prompt text in the value. Write it as a single flowing paragraph using the client's crisis/niche. Wrap key phrases in ** ** markers for highlighting.",
  "offerPrice": "$10,000",
