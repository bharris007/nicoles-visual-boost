    ...
    >
      ...
      <div className="w-[28%] flex flex-col items-center pt-8 md:pt-10 pb-6 px-4 relative border-r border-white/10">
        ...
        >
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 md:w-9 md:h-9 rounded-full bg-[hsl(145,65%,38%)] border-2 border-[hsl(45,100%,55%)] flex items-center justify-center shadow-md">
            <img src={gtFavicon} alt="Growth Tools" className="w-4 h-4 md:w-5 md:h-5" />
          </div>
        </motion.div>
      ...
      <div className="w-[72%] flex flex-col justify-center px-8 md:px-14 py-8 gap-4 md:gap-6 relative z-10">
        <motion.p
          ...
          className="text-white/50 text-xs md:text-sm font-semibold tracking-normal uppercase"
        >
